...
public class ParseFeed {
	...
	/*
	 * This method is to parse a file containing airport information. The file and
	 * its format can be found: http://openflights.org/data.html#airport
	 * 
	...
	/*
	 * This method is to parse a file containing airport route information. The file
	 * and its format can be found: http://openflights.org/data.html#route
	 * 
	 ...
	 * the world bank. The file and its format can be found:
	...
	public static HashMap<String, Float> loadLifeExpectancyFromCSV(PApplet p, String fileName) {
		...
		for (String row : rows) {
			...
			/*
			 * EXTENSION: Add code to also get the year the data is from. You may want to
			 * use a list of Floats as the values for the HashMap and store the year as the
			 * second value. (There are many other ways to do this)
			 */
			//
