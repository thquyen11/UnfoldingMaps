...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		AbstractMapProvider providerGoogle = new Google.GoogleTerrainProvider();
		AbstractMapProvider providerHEREMap= new Microsoft.AerialProvider();
		// Set a zoom level
		int zoomLevel = 15;
		...
		if (offline) {
			...
			providerGoogle = new MBTilesMapProvider(mbTilesString);
		...
		map1 = new UnfoldingMap(this, 50, 50, 350, 500, providerGoogle);
		...
		map2 = new UnfoldingMap(this, 450, 50, 350, 500, providerHEREMap);
		map2.zoomAndPanTo(zoomLevel, new Location(13.7244297f, 100.541207f));
