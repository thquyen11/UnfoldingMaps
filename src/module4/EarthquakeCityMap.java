...
//				m.setLocation(earthquake.getLocation());
				return true;
			}
...
//		for (Marker mc : countryMarkers) {
//			int cnt=0;
//			for (Marker me : quakeMarkers) {
//				if(me.get==mc.getProperty("country")) {
//					cnt++;
//				}
//				System.out.println(mc.getProperty("country")+" has: "+cnt+" earthquakes");
//			}
//		}
